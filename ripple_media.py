...
def box_office_data():
    ...
    # The final movie is the 50th element in the list, but is indexed at 49
...
def create_employee_email_address():
    ...
    email_domain = '@ripplemedia.com'
    email = (f'{joined_names}{email_domain}')
    print(email)
